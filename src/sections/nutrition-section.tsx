...
const NutritionSection = () => {
  ...
  useEffect(() => {
    if (isMobile) {
      ...
      // if it already has the whole list on desktop, don't change (avoiding unneccery rerender)
  ...
  return (
    <section className="nutrition-section">
      <img src="/assets/images/slider-dip.png" alt="dib photo" className="w-full object-cover" />

      <img src="/assets/images/big-img.png" alt="big spylt vanilla photo" className="big-img" />
        ...
        <div className="nutrition-box">
          <div className="list-wrapper">
            {lists.map((nutrient, index) => (
              <div key={index} className="relative flex-1 col-center overflow-hidden">
                <div>
